<?php 
	...
	class Cart extends Model {
		...
		public function getProductsTotals(){
			...
			$sql = new Sql();
			$results = $sql->select("SELECT SUM(vlprice) AS vlprice, SUM(vlwidth) AS vlwidth, SUM(vlweight) as vlweight, 
				SUM(vllength) vllength, SUM(vlheight) as vlheight, COUNT(*) as nrqtd
 				FROM tb_products a 
